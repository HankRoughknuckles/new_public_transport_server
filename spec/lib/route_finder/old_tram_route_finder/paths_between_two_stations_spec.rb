...
describe RouteFinder::OldTramRouteFinder::PathsBetweenTwoStations do
  describe '#[] operator' do
    it 'should access the @paths array' do
      paths_between_two_stations =
        RouteFinder::OldTramRouteFinder::PathsBetweenTwoStations.new(
          create(:station), create(:station)
        )
      paths_between_two_stations.add_path(RouteFinder::OldTramRouteFinder::Path.new([create(:segment)]))
      paths_between_two_stations.add_path(RouteFinder::OldTramRouteFinder::Path.new([create(:segment)]))
  ...
  describe 'add_path' do
    it 'should append the path to the end of the list' do
      ...
      path_to_be_added = RouteFinder::OldTramRouteFinder::Path.new([create(:segment)])
  ...
  describe 'shortest' do
    ...
    it 'should return the path from @paths that has the shortest travel_time' do
      ...
      paths_between_two_stations = RouteFinder::OldTramRouteFinder::PathsBetweenTwoStations.new(
        create(:station),
        create(:station)
      )
