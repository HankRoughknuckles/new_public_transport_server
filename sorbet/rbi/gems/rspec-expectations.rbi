...
#
# rspec-expectations-e48f774b0672
...
class InvalidName___Class_0x00___Differ_26
end
...
class RSpec::Matchers::BuiltIn::ChangeDetails
  ...
  def calculate_attribute_hashes(object); end
  def changed?; end
...
class RSpec::Matchers::BuiltIn::Exist::ExistenceTest < Anonymous_Struct_27
...
class RSpec::Matchers::BuiltIn::CaptureStreamToTempfile < Anonymous_Struct_28
...
class RSpec::Matchers::BuiltIn::YieldControl < RSpec::Matchers::BuiltIn::BaseMatcher
  ...
  def matches?(block); end
  def once; end
  def raise_impossible_yield_expectation(count); end
  def raise_unsupported_yield_expectation; end
  def set_expected_yields_count(relativity, n); end
  def supports_block_expectations?; end
  def thrice; end
  def times; end
  def twice; end
  def unsupported_yield_expectation?(relativity); end
end
