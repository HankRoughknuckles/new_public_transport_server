...
class Object
  ...
  ALL_LINES = ::T.let(nil, ::T.untyped)
  ARGF = ::T.let(nil, ::T.untyped)
  ARGV = ::T.let(nil, ::T.untyped)
  CROSS_COMPILING = ::T.let(nil, ::T.untyped)
  ENV = ::T.let(nil, ::T.untyped)
  LINE_1 = ::T.let(nil, ::T.untyped)
  LINE_10 = ::T.let(nil, ::T.untyped)
  LINE_11 = ::T.let(nil, ::T.untyped)
  LINE_12 = ::T.let(nil, ::T.untyped)
  LINE_2 = ::T.let(nil, ::T.untyped)
  LINE_3 = ::T.let(nil, ::T.untyped)
  LINE_4 = ::T.let(nil, ::T.untyped)
  LINE_5 = ::T.let(nil, ::T.untyped)
  LINE_6 = ::T.let(nil, ::T.untyped)
  LINE_7 = ::T.let(nil, ::T.untyped)
  LINE_8 = ::T.let(nil, ::T.untyped)
  LINE_9 = ::T.let(nil, ::T.untyped)
...
module Segment::GeneratedAttributeMethods
  ...
  def restore_station_a_id!(*args); end

  def restore_station_b_id!(*args); end

  def restore_travel_time!(*args); end
  ...
  def saved_change_to_station_a_id(*args); end

  def saved_change_to_station_a_id?(*args); end

  def saved_change_to_station_b_id(*args); end

  def saved_change_to_station_b_id?(*args); end

  def saved_change_to_travel_time(*args); end
  ...
  def station_a_id?(*args); end

  def station_a_id_before_last_save(*args); end

  def station_a_id_before_type_cast(*args); end

  def station_a_id_came_from_user?(*args); end

  def station_a_id_change(*args); end

  def station_a_id_change_to_be_saved(*args); end

  def station_a_id_changed?(*args); end

  def station_a_id_in_database(*args); end

  def station_a_id_previous_change(*args); end

  def station_a_id_previously_changed?(*args); end

  def station_a_id_was(*args); end

  def station_a_id_will_change!(*args); end

  def station_b_id(); end

  def station_b_id=(value); end

  def station_b_id?(*args); end

  def station_b_id_before_last_save(*args); end

  def station_b_id_before_type_cast(*args); end

  def station_b_id_came_from_user?(*args); end

  def station_b_id_change(*args); end

  def station_b_id_change_to_be_saved(*args); end

  def station_b_id_changed?(*args); end

  def station_b_id_in_database(*args); end

  def station_b_id_previous_change(*args); end

  def station_b_id_previously_changed?(*args); end

  def station_b_id_was(*args); end

  def station_b_id_will_change!(*args); end

  def travel_time(); end

  def travel_time=(value); end

  def travel_time?(*args); end

  def travel_time_before_last_save(*args); end

  def travel_time_before_type_cast(*args); end

  def travel_time_came_from_user?(*args); end

  def travel_time_change(*args); end

  def travel_time_change_to_be_saved(*args); end

  def travel_time_changed?(*args); end

  def travel_time_in_database(*args); end

  def travel_time_previous_change(*args); end

  def travel_time_previously_changed?(*args); end

  def travel_time_was(*args); end

  def travel_time_will_change!(*args); end
  ...
  def will_save_change_to_station_a_id?(*args); end

  def will_save_change_to_station_b_id?(*args); end

  def will_save_change_to_travel_time?(*args); end
...
class Station
  ...
  def after_add_for_neighbors(); end

  def after_add_for_neighbors=(val); end
  ...
  def after_remove_for_neighbors(); end

  def after_remove_for_neighbors=(val); end

  def after_remove_for_neighbors?(); end

  def autosave_associated_records_for_neighbor_segments(*args); end

  def autosave_associated_records_for_neighbors(*args); end
  ...
  def before_add_for_neighbors(); end

  def before_add_for_neighbors=(val); end
  ...
  def before_remove_for_neighbors(); end

  def before_remove_for_neighbors=(val); end

  def before_remove_for_neighbors?(); end

  def validate_associated_records_for_neighbor_segments(*args); end

  def validate_associated_records_for_neighbors(*args); end
end

module Station::GeneratedAssociationMethods
  def neighbor_ids(); end

  def neighbor_ids=(ids); end
...
module Station::GeneratedAttributeMethods
  ...
  def restore_simple_name!(*args); end
  ...
  def saved_change_to_simple_name(*args); end
  ...
  def simple_name?(*args); end

  def simple_name_before_last_save(*args); end

  def simple_name_before_type_cast(*args); end

  def simple_name_came_from_user?(*args); end

  def simple_name_change(*args); end

  def simple_name_change_to_be_saved(*args); end

  def simple_name_changed?(*args); end

  def simple_name_in_database(*args); end

  def simple_name_previous_change(*args); end

  def simple_name_previously_changed?(*args); end

  def simple_name_was(*args); end

  def simple_name_will_change!(*args); end
  ...
  def will_save_change_to_simple_name?(*args); end
...
class Station
  ...
  def self.after_add_for_neighbors(); end

  def self.after_add_for_neighbors=(val); end
  ...
  def self.after_remove_for_neighbors(); end

  def self.after_remove_for_neighbors=(val); end
  ...
  def self.before_add_for_neighbors(); end

  def self.before_add_for_neighbors=(val); end
  ...
  def self.before_remove_for_neighbors(); end

  def self.before_remove_for_neighbors=(val); end
...
class TramLine
  include ::TramLine::GeneratedAttributeMethods
